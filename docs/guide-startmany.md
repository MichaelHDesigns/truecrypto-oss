...
2. [Sending 5,000 TDC to new wallet addresses.](#option2)
...
[From the truecrypto-oss github repo](https://github.com/truedividendcryptocurrency/truecrypto-oss/blob/master/docs/masternode_conf.md)
