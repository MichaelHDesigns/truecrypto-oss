// Copyright (c) 2011-2020 Bitcoin Developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("True Crypto OSS") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About True Crypto OSS"), this);
    aboutAction->setStatusTip(tr("Show information about True Crypto OSS"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the True Crypto OSS help message to get a list with possible TDC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("True Crypto OSS Client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("True Crypto OSS"); // default title
