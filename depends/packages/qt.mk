...
$(package)_patches=mac-qmake.conf fix-xcb-include-order.patch mingw-uuidof.patch pidlist_absolute.patch fix-mouse-event.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 < $($(package)_patch_dir)/fix-mouse-event.patch && \
